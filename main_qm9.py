...
if args.resume is not None:
    ...
    print(args)
#创建output及其实验名称的文件夹，用于保存训练好的model
#默认放在./output中
...
if args.train_diffusion:#默认训练train_diffusion模型
    #if args中有AE模型保存路径(args.ae_path,'args.pickle')
    #有则加载AE模型，否则第一次run（默认没有经过训练的VAE模型)
