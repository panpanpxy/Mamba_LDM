...
import torch
import pickle
from qm9.models_mamba import get_model, get_autoencoder, get_latent_diffusion
from configs.datasets_config import get_dataset_info
from qm9 import dataset
from qm9.utils import compute_mean_mad
from qm9.sampling import sample
from qm9.property_prediction.main_qm9_prop_mamba import test
from qm9.property_prediction import main_qm9_prop_mamba
...
def get_classifier(dir_path='', device='cpu'):
    ...
    args_classifier.model_name = 'egmn'
    classifier = main_qm9_prop_mamba.get_model(args_classifier)
