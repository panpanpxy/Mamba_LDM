...
#1.sample每个node的原子数-nodexsample
#2.调用qm9.sampling中的sample函数，为原子填上coordinate和原子属性
#3.保存成xyz文件格式（文件后缀名:txt）
#4.调用analyze_stability_for_molecules函数计算stability,rdkit_metrics
...
def main():
   ...
   #加载model的权重
    ...
    #调用analyze_and_save函数，compute stability,validaity,uniqueness and novelty
